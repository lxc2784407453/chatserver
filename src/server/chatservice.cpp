...
ChatService::ChatService()
{
  ...
  _msgHandlerMap.insert({REG_MSG,std::bind(&ChatService::reg,this,_1,_2,_3)});
   ...
   {
    //设置消息上报的回调
    _redis.init_notify_handler(std::bind(&ChatService::hadnleRedsSubscribeMessage,this,_1,_2));
   }
}
...
void ChatService::createGroup(const TcpConnectionPtr &conn,json &js,Timestamp)
{
  ...
  if(_groupmodel.createGruop(group))
  {
    //存储群组创建人信息
...
//从redis中获取订阅的消息
void ChatService::hadnleRedsSubscribeMessage(int userid,string msg)
{
